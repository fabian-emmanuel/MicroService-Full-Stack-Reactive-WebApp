      ...
      <h2 id="tag-heading" data-cy="TagHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="gatewayApp.blogTag.home.refreshListLabel">Refresh List</Translate>
          </Button>
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="gatewayApp.blogTag.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
