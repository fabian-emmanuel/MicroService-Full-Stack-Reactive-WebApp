  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.blogPost.home.createOrEditLabel" data-cy="PostCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayApp.blogPost.title')}
                id="post-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.blogPost.content')}
                id="post-content"
                name="content"
                data-cy="content"
                type="textarea"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.blogPost.date')}
                id="post-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField id="post-blog" name="blogId" data-cy="blog" label={translate('gatewayApp.blogPost.blog')} type="select">
                <option value="" key="0" />
                {blogs
              ...
              <ValidatedField label={translate('gatewayApp.blogPost.tag')} id="post-tag" data-cy="tag" type="select" multiple name="tags">
                <option value="" key="0" />
                {tags
