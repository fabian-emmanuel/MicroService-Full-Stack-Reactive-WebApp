      ...
      <h2 id="post-heading" data-cy="PostHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="gatewayApp.blogPost.home.refreshListLabel">Refresh List</Translate>
          </Button>
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="gatewayApp.blogPost.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
