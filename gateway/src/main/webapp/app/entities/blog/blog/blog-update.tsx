        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayApp.blogBlog.name')}
                id="blog-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.blogBlog.handle')}
                id="blog-handle"
                name="handle"
                data-cy="handle"
                type="text"
              ...
              />
              <ValidatedField id="blog-user" name="userId" data-cy="user" label={translate('gatewayApp.blogBlog.user')} type="select">
                <option value="" key="0" />
                {users
