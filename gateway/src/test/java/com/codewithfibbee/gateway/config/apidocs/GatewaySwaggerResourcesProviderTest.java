package com.codewithfibbee.gateway.config.apidocs;

import static com.codewithfibbee.gateway.config.apidocs.GatewaySwaggerResourcesProvider.swaggerResource;
